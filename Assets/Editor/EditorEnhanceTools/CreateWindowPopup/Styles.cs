...
namespace Cr7Sund.CreateWindow
{
    ...
    internal static class Styles
    {
        ...
        static Styles()
        {
            ...
            foldIconClosed.normal.background = NiceIO.LoadEditorAsset<Texture2D>(CreateWindowConstants.FoldClosedPath);
            foldIconClosed.hover.background = NiceIO.LoadEditorAsset<Texture2D>(CreateWindowConstants.FoldClosedHoverPath);
            foldIconClosed.fixedWidth = 10;
            foldIconClosed.fixedHeight = 28;

            foldIconOpen = new GUIStyle();
            foldIconOpen.normal.background = NiceIO.LoadEditorAsset<Texture2D>(CreateWindowConstants.FoldOpenPath);
            foldIconOpen.hover.background = NiceIO.LoadEditorAsset<Texture2D>(CreateWindowConstants.FoldOpenHoverPath);
